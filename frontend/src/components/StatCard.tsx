...
export function StatCard({ value }: { value: number }) {
  return (
    <GlassCard className="relative overflow-hidden p-5">
      <div className="absolute inset-y-0 right-0 w-36 bg-[radial-gradient(circle_at_center,rgba(110,231,183,.12),transparent_68%)]" aria-hidden="true" />
      <div className="relative flex items-center justify-between gap-5">
        ...
        <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-lg border border-emerald-300/15 bg-emerald-300/[0.08] text-emerald-300">
